    ...
    <div class="container">
        <form class="form" action="../back/cadastroProf_back.php" method="post">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <!--  <label class="areas" for="InputEmail1">itulo sua experiencia</label> -->
                    <input type="sel" class="form-control" id="Experiencia" placeholder="Cidade" name="Título">
                </div>
                <div class="form-group">
                    <!--  <label class="areas" for="InputEmail1">itulo sua experiencia</label> -->
                    <input type="exp" class="form-control" id="Experiencia" placeholder="Bairro" name="Título">
                </div>
                <div class="form-group">
                    <!--  <label class="areas" for="InputEmail1">itulo sua experiencia</label> -->
                    <input type="exp" class="form-control" id="Experiencia" placeholder="Endereço" name="Título">
                </div>
                <div class="form-group">
